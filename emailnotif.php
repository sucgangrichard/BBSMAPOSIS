...
require 'conndb.php'; // Include database connection or configuration file
...
function checkStockLevels($pdo) {
    ...
    if (!$lastNotification || (time() - strtotime($lastNotification['last_notification'])) > 86400) {
...
function sendEmailNotification($productName, $stock) {
    ...
    try {
        ...
        //Recipients
        $mail->setFrom('richard.l.sucgang@gmail.com', 'Stock Notification');
