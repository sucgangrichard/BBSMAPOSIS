...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Stock Usage Monitor</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
...
function addrow(id, barcode, product_name, stock, category, date_of_receipt, expiration_date) {
    var tr = '<tr>' +
        '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-muted" name="" id="' + id + '">' + barcode + '</span><input type="hidden" class="form-control" name="" id="' + id + '" value="' + barcode + '"></td>' +
        '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-info " name="" id="' + id + '">' + product_name + '</span><input type="hidden" class="form-control " name="" id="' + id + '" value="' + product_name + '"></td>' +
        '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-info stock_id" name="" id="stock_id' + id + '">' + stock + '</span><input type="hidden" class="form-control stock_id" name="" id="stock_id' + id + '" value="' + stock + '"></td>' +
        '<td><input type="text" class="form-control qty_id_c" name="" id="qty_id' + id + '" value="' + 1 + '" size="1" readonly></td>' +
        '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-info " name="" id="' + id + '">' + category + '</span><input type="hidden" class="form-control " name="" id="' + id + '" value="' + category + '"></td>' +
        '<td style="text-align:left; vertical-align:middle; font-size:17px;"><span class="badge badge-info " name="" id="' + id + '">' + date_of_receipt + '</span><input type="hidden" class="form-control " name="" id="' + id + '" value="' + date_of_receipt + '"></td>' +
